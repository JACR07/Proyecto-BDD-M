...
-- crear tablas, llaves primarias, llaves foraneas,
-- constraints, trigger, funcion y procedimiento almacenado.

DROP SCHEMA IF EXISTS hotel_reservas CASCADE;
CREATE SCHEMA hotel_reservas;
SET search_path TO hotel_reservas;

-- Necesaria para usar EXCLUDE con enteros y rangos de fechas.
...
-- Constraint para evitar doble reserva de una misma habitacion
