-- Incluyen filtros, fechas, agregaciones y multiples tablas.

SET search_path TO hotel_reservas;

-- 1. Habitaciones disponibles en un rango de fechas.
-- Cambiar las fechas segun la prueba requerida.
SELECT
    h.id_habitacion,
    ho.nombre AS hotel,
    h.numero,
...
-- 5. Ingresos totales por mes en el anio actual del dataset.
SELECT
